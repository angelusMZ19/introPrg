        ...
        if(pis.equals("planta baixa") && botó.equals("pujar un")) {
            System.out.println("primer pis");
                ...
                System.out.println("segon pis");}
                    else if(pis.equals("planta baixa") && botó.equals("baixar un")||botó.equals("baixar dos") || botó.equals("baixar tres")) {
                    System.out.println("error");}
        ...
        if(pis.equals("primer pis") && botó.equals("pujar un")) {
            System.out.println("segon pis");}
                ...
                System.out.println("planta baixa");}
                    else if(pis.equals("primer pis") && botó.equals("pujar dos")||botó.equals("baixar dos") || botó.equals("baixar tres")||botó.equals("pujar tres")) {
                    System.out.println("error");}
